...
//                                    }
            ...
            composable(
                ...
                Log.i("NavGraphContentLambdaBuilder","NavigationArgs  show returnedData : $returnedNewsTitle")
                PageLogin(
                    onNavigateToNews = {result->
                        val stringToEncode = result ?: ""
                        Log.i("NavGraphContentLambdaBuilder","NavigationArgs  login  Processed: $result")
