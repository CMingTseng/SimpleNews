...
fun NavController.navigate(
    ...
    val routeLink = NavDeepLinkRequest
        ...
        .build()
    Log.i("NavController_Exp","Show me NavDestination route ${navdestinationroute} \n uri $navdestinationrouteUri \n routeLink $routeLink")
    val deepLinkMatch = graph.matchDeepLink(routeLink)
    Log.i("NavController_Exp","--- Printing NavGraph Details ---")
//    printNavGraphDetails(this.graph)
    Log.i("NavController_Exp","--- End of NavGraph Details ---")
...
private fun printNavGraphDetails(navGraph: NavGraph, indent: String = "") {
    Log.i("NavController_Exp","${indent}Graph ID: ${navGraph.id}, Route: ${navGraph.route}, DisplayName: ${navGraph.displayName}")
    println()
    navGraph.forEach { destination ->
        Log.i("NavController_Exp","${indent}  Destination ID: ${destination.id}, Route: ${destination.route}, DisplayName: ${destination.displayName}, Navigator: ${destination.navigatorName}")
